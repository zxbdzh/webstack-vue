    ...
    components.onclick = () => {
      if (isMoved) {
        ...
        mainButton.style.boxShadow =
          '3 3em 5em rgba(0, 0, 0, 0.5), inset  -3em -5em 3em -3em rgba(0, 0, 0, 0.em5), inset  4em 5em 2em -2em rgba(255, 230, 80,1)'
